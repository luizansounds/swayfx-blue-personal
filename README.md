...
> **Note**
> Everywhere in this repository, make sure to replace `luiza1011/swayfx-blue` with the details of your own repository. Unless you used [`create-ublue-image`](https://github.com/EinoHR/create-ublue-image), in which case the previous repo identifier should already be your repo's details.
...
Read [the README in the `scripts/` directory](https://github.com/luiza1011/swayfx-blue/blob/main/scripts/README.md) for more information.
...
- First rebase to the image unsigned, to get the proper signing keys and policies installed:
  ```
  sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/luiza1011/swayfx-blue:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/luiza1011/swayfx-blue:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/luiza1011/swayfx-blue:20230403
```
...
To run the action, simply edit the `boot_menu.yml` by changing all the references to `luiza1011/swayfx-blue` to your repository. This should trigger the action automatically.
